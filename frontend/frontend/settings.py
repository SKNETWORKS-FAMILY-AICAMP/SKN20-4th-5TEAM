...
LANGUAGE_CODE = 'ko-kr' # 설명: 한국어로 설정
 
TIME_ZONE = 'Asia/Seoul' # 설명: 서울 시간대로 설정
...
STATIC_URL = "/static/" # 설명: 정적 파일 URL 경로
STATICFILES_DIRS = [
    BASE_DIR / 'static', # 설명 : 프로젝트 내 static 폴더
]
STATIC_ROOT = BASE_DIR / 'staticfiles' # 설명: collectstatic 명령어로 모아질 디렉토리
